export const FrenchModalBody = "The French system is an internationally recognised system for grading sport " +
    "climbs and is therefore used on bolted routes within the UK."

export const UIAAModalBody = "This system is used in Germany, in other areas of Eastern Europe and in Italy for " +
    "the classic trad routes."

export const YDSModalBody = "The Yosemite Decimal System is a grading system commonly found in the United States, " +
...
export const BritishTradModalBody = "The UK system is made of two sub-grades, an adjective grade and a technical grade. " +
...
export const AustralianModalBody = "The system used in Australia and New Zealand is perhaps the most logical of all. " +
    "There are no letters secondary grades, just a single number which gets bigger as the routes get harder."

export const BritishTechnicalModalBody = " there to give an indication of the hardest move to be found on the route, " +
